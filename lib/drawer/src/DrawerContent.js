  ...
  render() {
    ...
    return (0, vue_1.h)(
      ...
      $slots.header || title || closable
        ? (0, vue_1.h)(
            'div',
            { class: `${mergedClsPrefix}-drawer-header`, style: headerStyle },
            (0, vue_1.h)(
              'div',
      ...
      nativeScrollbar
        ? (0, vue_1.h)(
            'div',
            { class: `${mergedClsPrefix}-drawer-body`, style: bodyStyle },
            (0, vue_1.h)(
              'div',
              {
      ...
      $slots.footer
        ? (0, vue_1.h)(
            'div',
            { class: `${mergedClsPrefix}-drawer-footer`, style: footerStyle },
            $slots.footer()
          )
        : null
    )
