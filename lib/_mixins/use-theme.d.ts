...
export declare type ExtractThemeVars<T> = T extends Theme<
  unknown,
  infer U,
  unknown
>
  ? unknown extends U
    ...
    : U
  : {}
export declare type ExtractPeerOverrides<T> = T extends Theme<
  unknown,
  unknown,
  infer V
>
  ...
  : T
export declare type ExtractMergedPeerOverrides<T> = T extends Theme<
  unknown,
  unknown,
  infer V
>
  ...
  : T
export declare type ExtractThemeOverrides<T> = Partial<ExtractThemeVars<T>> &
