...
const tagDark = {
  ...
  self(vars) {
    ...
    return Object.assign(Object.assign({}, _common_1.default), {
      ...
      colorPrimary: '#0000',
      closeColorPrimary: (0, seemly_1.changeColor)(primaryColor, {
        alpha: 0.7
      }),
      ...
      colorInfo: '#0000',
      closeColorInfo: (0, seemly_1.changeColor)(infoColor, { alpha: 0.7 }),
      ...
      colorSuccess: '#0000',
      closeColorSuccess: (0, seemly_1.changeColor)(successColor, {
        alpha: 0.7
      }),
      ...
      colorWarning: '#0000',
      closeColorWarning: (0, seemly_1.changeColor)(warningColor, {
        alpha: 0.7
      }),
      ...
      colorError: '#0000',
      closeColorError: (0, seemly_1.changeColor)(errorColor, { alpha: 0.7 }),
