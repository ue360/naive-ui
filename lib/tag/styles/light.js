...
const self = (vars) => {
  ...
  return Object.assign(Object.assign({}, _common_1.default), {
    ...
    colorPrimary: (0, seemly_1.changeColor)(primaryColor, { alpha: 0.1 }),
    closeColorPrimary: (0, seemly_1.changeColor)(primaryColor, { alpha: 0.75 }),
    ...
    colorInfo: (0, seemly_1.changeColor)(infoColor, { alpha: 0.1 }),
    closeColorInfo: (0, seemly_1.changeColor)(infoColor, { alpha: 0.75 }),
    closeColorHoverInfo: (0, seemly_1.changeColor)(infoColor, { alpha: 0.6 }),
    closeColorPressedInfo: (0, seemly_1.changeColor)(infoColor, { alpha: 0.9 }),
    borderSuccess: `1px solid ${(0, seemly_1.changeColor)(successColor, {
      alpha: 0.3
    })}`,
    textColorSuccess: successColor,
    colorSuccess: (0, seemly_1.changeColor)(successColor, { alpha: 0.1 }),
    closeColorSuccess: (0, seemly_1.changeColor)(successColor, { alpha: 0.75 }),
    ...
    colorWarning: (0, seemly_1.changeColor)(warningColor, { alpha: 0.12 }),
    closeColorWarning: (0, seemly_1.changeColor)(warningColor, { alpha: 0.75 }),
    ...
    colorError: (0, seemly_1.changeColor)(errorColor, { alpha: 0.08 }),
    closeColorError: (0, seemly_1.changeColor)(errorColor, { alpha: 0.65 }),
    closeColorHoverError: (0, seemly_1.changeColor)(errorColor, { alpha: 0.5 }),
