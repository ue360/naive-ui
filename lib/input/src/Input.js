...
const inputProps = Object.assign(Object.assign({}, _mixins_1.useTheme.props), {
  bordered: {
    type: Boolean,
    default: undefined
  },
...
exports.default = (0, vue_1.defineComponent)({
  ...
  setup(props) {
    ...
    const { mergedClsPrefixRef, mergedBorderedRef } = (0, _mixins_1.useConfig)(
      props
    )
      ...
      return (
        ...
        ((0, utils_1.isEmptyValue)(mergedValue) ||
          (Array.isArray(mergedValue) &&
            (0, utils_1.isEmptyValue)(mergedValue[0]))) &&
        mergedPlaceholder[0]
      )
    })
    const showPlaceholder2Ref = (0, vue_1.computed)(() => {
      ...
      return (
        ...
        ((0, utils_1.isEmptyValue)(mergedValue) ||
          (Array.isArray(mergedValue) &&
            (0, utils_1.isEmptyValue)(mergedValue[1])))
      )
    })
    // focus
    ...
    return (0, vue_1.h)(
      ...
      (0, vue_1.h)(
        ...
        this.$slots.affix || this.$slots.prefix
          ? (0, vue_1.h)(
              ...
              (0, vue_1.renderSlot)(this.$slots, 'affix', undefined, () => {
          ...
          : (0, vue_1.h)(
              ...
              this.showPlaceholder1
                ? (0, vue_1.h)(
                    'div',
                    { class: `${mergedClsPrefix}-input__placeholder` },
                    (0, vue_1.h)('span', null, this.mergedPlaceholder[0])
                  )
                : null,
              this.autosize
                ? (0, vue_1.h)(
          ...
          ? (0, vue_1.h)('div', { class: `${mergedClsPrefix}-input__suffix` }, [
              this.clearable || this.$slots.clear
                ? (0, vue_1.h)(
                    ...
                    {
                      default: () => (0, vue_1.renderSlot)(this.$slots, 'clear')
                    }
                  )
                : null,
              (0, vue_1.renderSlot)(this.$slots, 'suffix'),
              this.loading !== undefined
                ? (0, vue_1.h)(_internal_1.NBaseSuffix, {
                    clsPrefix: mergedClsPrefix,
              ...
              this.mergedShowPasswordOn && this.type === 'password'
                ? (0, vue_1.h)(
                    ...
                    },
                    {
                      default: () =>
                        this.passwordVisible
                          ? (0, vue_1.h)(icons_1.EyeIcon, null)
                          : (0, vue_1.h)(icons_1.EyeOffIcon, null)
                    }
                  )
                : null
            ])
      ...
      this.pair
        ? (0, vue_1.h)(
            ...
            (0, vue_1.renderSlot)(this.$slots, 'separator', undefined, () => [
              this.separator
            ])
          )
        : null,
      this.pair
            ...
            (0, vue_1.h)(
              ...
              this.showPlaceholder2
                ? (0, vue_1.h)(
                    'div',
                    { class: `${mergedClsPrefix}-input__placeholder` },
                    (0, vue_1.h)('span', null, this.mergedPlaceholder[1])
                  )
                : null
            ),
            (0, vue_1.h)('div', { class: `${mergedClsPrefix}-input__suffix` }, [
        ...
        : null,
      this.mergedBordered
        ? (0, vue_1.h)('div', { class: `${mergedClsPrefix}-input__border` })
        : null,
      this.mergedBordered
        ? (0, vue_1.h)('div', {
