...
exports.colorPickerPanelProps = Object.assign(
...
exports.default = (0, vue_1.defineComponent)({
  ...
  setup(props, { slots }) {
    ...
    const displayedModeRef = (0, vue_1.ref)(
      (0, utils_1.getModeFromValue)(mergedValueRef.value) || 'rgb'
    )
    ...
    function handleUpdateSv(s, v) {
      ...
      switch (displayedModeRef.value) {
        case 'hsv':
          doUpdateValue(
            (showAlpha ? seemly_1.toHsvaString : seemly_1.toHsvString)([
              hue,
              s,
              v,
              alpha
        ...
        case 'hsl':
          doUpdateValue(
            (showAlpha ? seemly_1.toHslaString : seemly_1.toHslString)([
        ...
        case 'rgb':
          doUpdateValue(
            (showAlpha ? seemly_1.toRgbaString : seemly_1.toRgbString)([
        ...
        case 'hex':
          doUpdateValue(
            (showAlpha ? seemly_1.toHexaString : seemly_1.toHexString)([
              ...(0, seemly_1.hsv2rgb)(hue, s, v),
              alpha
            ]),
            'cursor'
          ...
          (0, vue_1.h)(
            ...
            props.showPreview
              ? (0, vue_1.h)(ColorPreview_1.default, {
                  ...
                  color:
                    rgbaRef.value && (0, seemly_1.toHexString)(rgbaRef.value),
      ...
      (0, vue_1.h)(vueuc_1.VBinder, null, {
        default: () => [
          (0, vue_1.h)(vueuc_1.VTarget, null, {
            default: () =>
              (0, vue_1.h)(ColorPickerTrigger_1.default, {
                clsPrefix: mergedClsPrefix,
