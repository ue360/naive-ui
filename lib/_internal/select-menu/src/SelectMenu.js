  ...
  setup(props) {
    ...
    const itemSizeRef = (0, vue_1.computed)(() => {
      return (0, seemly_1.depx)(
        themeRef.value.self[(0, cssr_1.createKey)('optionHeight', props.size)]
      )
    })
    const paddingRef = (0, vue_1.computed)(() => {
      return (0, seemly_1.getPadding)(
        themeRef.value.self[(0, cssr_1.createKey)('padding', props.size)]
      )
    })
    ...
    const cssVarsRef = (0, vue_1.computed)(() => {
      ...
      const {
        ...
        self: {
          ...
          [(0, cssr_1.createKey)('optionPadding', size)]: optionPadding
        }
      } = themeRef.value
      return {
        '--height': height,
        ...
        '--option-padding-left': (0, seemly_1.getPadding)(
          optionPadding,
          'left'
        ),
    ...
    return (0, vue_1.h)(
      ...
      this.loading
                      ...
                      },
                      {
                        default: ({ item: tmNode }) => {
                          return tmNode.isGroup
                            ? (0, vue_1.h)(SelectGroupHeader_1.default, {
                                key: tmNode.key,
                                clsPrefix: clsPrefix,
                                tmNode: tmNode
                              })
                            : tmNode.ignored
                            ? null
                            : (0, vue_1.h)(SelectOption_1.default, {
                                clsPrefix: clsPrefix,
                                key: tmNode.key,
                                tmNode: tmNode
                              })
        ...
        : (0, vue_1.h)(
            ...
            (0, vue_1.renderSlot)($slots, 'empty', undefined, () => [
