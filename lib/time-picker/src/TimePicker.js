...
const timePickerProps = Object.assign(
...
exports.default = (0, vue_1.defineComponent)({
  ...
  setup(props) {
    ...
    const { mergedBorderedRef, mergedClsPrefixRef, namespaceRef } = (0,
    ...
    const hourValueRef = (0, vue_1.computed)(() => {
      ...
      if (value === null) return null
      return Number(
        (0, date_fns_1.format)(value, 'HH', dateFnsOptionsRef.value)
      )
    })
    const minuteValueRef = (0, vue_1.computed)(() => {
      ...
      if (value === null) return null
      return Number(
        (0, date_fns_1.format)(value, 'mm', dateFnsOptionsRef.value)
      )
    })
    const secondValueRef = (0, vue_1.computed)(() => {
      ...
      if (value === null) return null
      return Number(
        (0, date_fns_1.format)(value, 'ss', dateFnsOptionsRef.value)
      )
    })
    ...
    function handleTriggerClick(e) {
      if (mergedDisabledRef.value || (0, seemly_1.happensIn)(e, 'clear')) return
    ...
    function handleAmPmClick(amPm) {
      ...
      if (mergedValue === null) {
        ...
        if (amPm === 'pm' && hours < 12) {
          doChange(
            (0, date_fns_1.getTime)((0, date_fns_1.setHours)(now, hours + 12))
          )
    ...
    function deriveInputValue(time) {
      ...
      if (time === null) displayTimeStringRef.value = ''
        ...
        displayTimeStringRef.value = (0, date_fns_1.format)(
          time,
          props.format,
          dateFnsOptionsRef.value
        )
    ...
    function handleNowClick() {
      ...
      const [mergeHours, mergeMinutes, mergeSeconds] = [
        ...
        !props[i] || (0, utils_2.isTimeInStep)(getNowTime[i](now), i, props[i])
          ? getNowTime[i](now)
