  ...
  setup(props) {
    ...
    if (props.onPrev) {
      ;(0, vue_1.watch)(showRef, (value) => {
        if (value) (0, evtd_1.on)('keyup', document, handleKeyup)
        else (0, evtd_1.off)('keyup', document, handleKeyup)
      })
    }
    let startX = 0
    let startY = 0
                              ...
                              this.show
                                ? (0, vue_1.h)(
                                    ...
                                    (0, vue_1.h)(
                                      ...
                                      {
                                        default: () =>
                                          (0, vue_1.h)(icons_1.ZoomInIcon, null)
                                      }
                                    ),
                                    (0, vue_1.h)(
                                      _internal_1.NBaseIcon,
