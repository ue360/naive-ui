      ...
      if (Array.isArray(mergedValueRef.value)) {
        ...
        if (checked) {
          if (!~index) {
            ...
            if (onUpdateValue) (0, _utils_1.call)(onUpdateValue, groupValue)
            if (_onUpdateValue) (0, _utils_1.call)(_onUpdateValue, groupValue)
            nTriggerFormInput()
            nTriggerFormChange()
          ...
          if (~index) {
            ...
            if (onUpdateValue) (0, _utils_1.call)(onUpdateValue, groupValue)
            if (_onUpdateValue) (0, _utils_1.call)(_onUpdateValue, groupValue)
            if (onChange) (0, _utils_1.call)(onChange, groupValue) // deprecated
            uncontrolledValueRef.value = groupValue
            nTriggerFormInput()
            nTriggerFormChange()
          }
        ...
        if (checked) {
          if (onUpdateValue) (0, _utils_1.call)(onUpdateValue, [checkboxValue])
          if (_onUpdateValue)
            (0, _utils_1.call)(_onUpdateValue, [checkboxValue])
          if (onChange) (0, _utils_1.call)(onChange, [checkboxValue]) // deprecated
          uncontrolledValueRef.value = [checkboxValue]
          nTriggerFormInput()
          nTriggerFormChange()
        } else {
          if (onUpdateValue) (0, _utils_1.call)(onUpdateValue, [])
          if (_onUpdateValue) (0, _utils_1.call)(_onUpdateValue, [])
          if (onChange) (0, _utils_1.call)(onChange, []) // deprecated
