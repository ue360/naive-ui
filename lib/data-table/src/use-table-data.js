...
function useTableData(props, { dataRelatedColsRef }) {
  ...
  const mergedFilterStateRef = (0, vue_1.computed)(() => {
    ...
    const activeFilters = Object.assign(
      (0, utils_1.createShallowClonedObject)(uncontrolledFilterStateRef.value),
  ...
  const mergedCurrentPageRef = (0, vooks_1.useMergedState)(
  ...
  function doUpdatePage(page) {
    ...
    if (onUpdatePage) (0, _utils_1.call)(onUpdatePage, page)
    if (_onUpdatePage) (0, _utils_1.call)(_onUpdatePage, page)
    if (onPageChange) (0, _utils_1.call)(onPageChange, page)
